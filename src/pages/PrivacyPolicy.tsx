  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-4 py-24 max-w-4xl">
        <h1 className="text-4xl font-display font-bold mb-8 text-white uppercase">Privacy Policy</h1>
        ...
        <div className="space-y-8 text-gray-300">
          <section>
            ...
            <p>
              Welcome to Dream Fitness Center. We respect your privacy and are committed to protecting your personal data. 
          ...
          <section>
            ...
            <p className="mt-2 text-primary">info@dreamfitness.com</p>
          </section>
        </div>
      </div>
      <Footer />
